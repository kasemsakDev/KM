...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    {
        $id = $_GET['id'];
        $sql_Edit = "SELECT RoleID,Name FROM km_role Where RoleID = $id";
        $result_Role = mysqli_query($link,$sql_Edit);
        $role = [];
...
<head>
                    ...
                    <div class="topbar-item">
                        <div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                            <div class="d-flex flex-column text-right pr-sm-3">
                                <span class="text-white font-weight-bolder font-size-sm d-none d-sm-inline">List Role</span>
                            </div>
  ...
  <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Create Role</h5>
									<!--end::Title-->
									<!--begin::Separator-->
                    ...
                    <div class="wizard wizard-1" id="kt_contact_add" data-wizard-state="first" data-wizard-clickable="true">
											<!--begin::Wizard Nav-->
                                            <form action="Manage/addrole.php" method="POST" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_contact_add_form">
											<!--end::Wizard Nav-->
											<!--begin::Wizard Body-->
                                            <input type="hidden" name="RoleID" value="<?php echo $user[0]['RoleID']  ?>">
												...
												<div class="col-xl-12 col-xxl-7">
													...
													<form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_contact_add_form">
														...
														<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
															<h3 class="mb-10 font-weight-bold text-dark">Create New Role</h3>
															<div class="row">
																<div class="col-xl-12">
																	<div class="form-group row fv-plugins-icon-container">
																		<label class="col-xl-3 col-lg-3 col-form-label">Role Name</label>
																		<div class="col-lg-9 col-xl-9">
																			<input class="form-control form-control-lg" name="name" type="text" value="<?php echo $role[0]['Name'] ?>" required>
